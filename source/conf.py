...
# -*- coding: utf-8 -*-
#
# Eagle Pass Guide documentation build configuration file, created by
# sphinx-quickstart on Sun Aug  6 13:07:35 2017.
#
...
project = 'Eagle Pass'
copyright = '2017-2018, Viktor Haag'
author = 'Viktor Haag'
...
#
html_theme_options = {
    'description': 'West Marches-style campaign guide',
...
htmlhelp_basename = 'EaglePassGuidedoc'
...
latex_documents = [
    (master_doc, 'EaglePassGuide.tex', 'Eagle Pass Guide Documentation',
     'Viktor Haag', 'manual'),
]
...
man_pages = [
    (master_doc, 'eaglepassguide', 'Eagle Pass Guide Documentation',
     [author], 1)
]
